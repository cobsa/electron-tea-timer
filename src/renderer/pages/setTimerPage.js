    ...
    return (
      <div className="container">
        <form>
          <div className="upButton">
            <div className="firstRow btn-group btn-group-sm " role="group">
              <button
                ...
                onClick={e => this.addTime(5, 'hour', e)}
              >
                +5
              </button>
              <button
                type="button"
                className="btn btn-change"
                onClick={e => this.addTime(5, 'minute', e)}
              >
                +5
              </button>
              <button
                type="button"
                className="btn btn-change"
                onClick={e => this.addTime(5, 'second', e)}
              >
                +5
              </button>
            </div>
            <div className="secondRow btn-group  btn-group-sm" role="group">
              <button
                type="button"
                className="btn btn-change"
                onClick={e => this.addTime(1, 'hour', e)}
              >
                +1
              </button>
              <button
                type="button"
                className="btn btn-change"
                onClick={e => this.addTime(1, 'minute', e)}
              >
                +1
              </button>
              <button
                type="button"
                className="btn btn-change"
                onClick={e => this.addTime(1, 'second', e)}
              >
                +1
              </button>
            </div>
          ...
          <div className="timer">
            <div id="timer" className={'timer ' + this.state.alertClass}>
              {setTime}
            </div>
          </div>
